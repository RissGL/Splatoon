	...
	public class MatchEditorCamera : MonoBehaviour
	{
		...
		void Update()
		{
			...
			if (Application.isPlaying == true && matchCameraDurringPlay == false)
			{
				...
				{
					mouseDelta = (lastMousePosition - UnityEngine.Input.mousePosition) * 0.1f;
				}
				...
				targetRotation = targetTransform.rotation *
					Quaternion.Euler(randRotX * swimAmount, randRotY * swimAmount, randRotZ * swimAmount);
